...
public final class ClientStreamingGrpc {
  ...
  public static final String SERVICE_NAME = "clientstreaming.ClientStreaming";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<Clientstreaming.Message,
      Clientstreaming.Number> getGetServerResponseMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetServerResponse",
      requestType = Clientstreaming.Message.class,
      responseType = Clientstreaming.Number.class,
      methodType = io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
  public static io.grpc.MethodDescriptor<Clientstreaming.Message,
      Clientstreaming.Number> getGetServerResponseMethod() {
    io.grpc.MethodDescriptor<Clientstreaming.Message, Clientstreaming.Number> getGetServerResponseMethod;
      ...
      synchronized (ClientStreamingGrpc.class) {
        if ((getGetServerResponseMethod = ClientStreamingGrpc.getGetServerResponseMethod) == null) {
          ClientStreamingGrpc.getGetServerResponseMethod = getGetServerResponseMethod =
              io.grpc.MethodDescriptor.<Clientstreaming.Message, Clientstreaming.Number>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetServerResponse"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  Clientstreaming.Message.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  Clientstreaming.Number.getDefaultInstance()))
  ...
  /**
   */
  public static abstract class ClientStreamingImplBase implements io.grpc.BindableService {

    /**
     */
    public io.grpc.stub.StreamObserver<Clientstreaming.Message> getServerResponse(
        io.grpc.stub.StreamObserver<Clientstreaming.Number> responseObserver) {
  ...
  /**
   */
  public static final class ClientStreamingStub extends io.grpc.stub.AbstractAsyncStub<ClientStreamingStub> {
  ...
  /**
   */
  public static final class ClientStreamingBlockingStub extends io.grpc.stub.AbstractBlockingStub<ClientStreamingBlockingStub> {
  ...
  /**
   */
  public static final class ClientStreamingFutureStub extends io.grpc.stub.AbstractFutureStub<ClientStreamingFutureStub> {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    private final ClientStreamingImplBase serviceImpl;
    private final int methodId;

    MethodHandlers(ClientStreamingImplBase serviceImpl, int methodId) {
  ...
  private static abstract class ClientStreamingBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return Clientstreaming.getDescriptor();
    }
  ...
  private static final class ClientStreamingMethodDescriptorSupplier
    ...
    ClientStreamingMethodDescriptorSupplier(String methodName) {
